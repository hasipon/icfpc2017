...
Main.__name__ = true;
Main.main = function() {
	var rootContext = new core_RootContext();
	ReactDOM.render(React.createElement(component_root_RootView,{ context : rootContext}),window.document.getElementById("control"));
