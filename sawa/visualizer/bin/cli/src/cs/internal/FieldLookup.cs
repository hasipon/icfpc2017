...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{97, 98, 105, 109, 120, 121, 23515, 24408, 4745537, 4849249, 4899635, 5144726, 5393365, 5442204, 5594513, 5594516, 5741474, 5744817, 42740551, 57476627, 76061764, 87367608, 116192081, 132916898, 141062784, 142301684, 208459108, 209784577, 288167040, 305151978, 328878574, 334695532, 359333139, 360725482, 404153790, 407283053, 452737314, 473088699, 480756972, 493819893, 501039929, 520590566, 586597902, 590053407, 610723709, 640252688, 652994848, 701410669, 784433846, 842117339, 878103594, 922671056, 929414088, 946786476, 947296307, 995006396, 999785710, 1042138122, 1058556349, 1067353468, 1071652316, 1103412149, 1113806382, 1119591629, 1147073522, 1158860648, 1181037546, 1191633396, 1204816148, 1224901875, 1225098545, 1228056441, 1238832007, 1247875546, 1280549057, 1280842308, 1280845662, 1282943179, 1313416818, 1333325768, 1348037855, 1350575496, 1352786672, 1381630732, 1395555037, 1398464674, 1431819701, 1436822557, 1450762973, 1477328871, 1531215442, 1532710347, 1537812987, 1571143203, 1576149820, 1620824029, 1621420777, 1623148745, 1639293562, 1682944316, 1705629508, 1707283357, 1763375486, 1768617329, 1915412854, 1916009602, 1970444429, 2022294396, 2025055113, 2027516754, 2048392659, 2049945213, 2054707467, 2082663554, 2094299916, 2127021138};
		
		protected static string[] fields = new string[]{"a", "b", "i", "m", "x", "y", "id", "me", "__a", "arr", "buf", "get", "len", "map", "pop", "pos", "set", "str", "flags", "getEnumConstructs", "remove", "filter", "target", "stderr", "mines", "resize", "parseString", "output", "stream", "hostEntry", "iterator", "indent", "lastIndexOf", "connect", "replacer", "hasNext", "reverse", "punters", "nOccupied", "getBytes", "insert", "length", "maxScore", "setupMap", "writeFullBytes", "writeString", "invalidNumber", "invalidChar", "pretty", "source", "fieldsString", "cachedIndex", "waitSetup", "toString", "owner", "hashes", "accessableSites", "input", "_eof", "splice", "exists", "copy", "date", "getAnother", "game", "host", "join", "keys", "concat", "next", "nind", "enumConstructor", "writeByte", "push", "size", "sock", "sort", "quicksort", "vals", "siteCount", "write", "scoreDictionary", "spliceVoid", "writeBytes", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "parseRec", "rivers", "setupPanters", "concatNative", "nBuckets", "riverCount", "quote", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "mineCount", "toDynamic", "isMine", "readByte", "allEnums", "__get", "__set", "ipAddress", "upperBound", "unshift", "score", "_keys", "setup", "enumParameters", "shift", "sites", "slice"};
