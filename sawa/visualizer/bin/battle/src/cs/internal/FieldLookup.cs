...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{97, 98, 105, 109, 120, 121, 23515, 4745537, 4849249, 5144726, 5393365, 5442204, 5594513, 5594516, 5741474, 5744817, 22986280, 42740551, 46374763, 57476627, 76061764, 77473234, 87367608, 96662113, 116192081, 141062784, 142301684, 182695950, 207998018, 208459108, 243225909, 288167040, 302979532, 328878574, 359333139, 407283053, 447461205, 451121863, 452737314, 473088699, 480756972, 493819893, 501039929, 520590566, 586597902, 589103123, 590053407, 652994848, 701410669, 740702967, 842117339, 922671056, 931871949, 946786476, 947296307, 999785710, 1012126063, 1034971558, 1058556349, 1067353468, 1071652316, 1103412149, 1119591629, 1125936028, 1147073522, 1164670177, 1181037546, 1191633396, 1204816148, 1213755260, 1214309137, 1214453688, 1224901875, 1228056441, 1246880977, 1247875546, 1280549057, 1280845662, 1282943179, 1313416818, 1333325768, 1337394146, 1350575496, 1352786672, 1395555037, 1398464674, 1431819701, 1436822557, 1450762973, 1477328871, 1492589217, 1516746174, 1532710347, 1537812987, 1547539107, 1571143203, 1620824029, 1621420777, 1623148745, 1639293562, 1648581351, 1682944316, 1705629508, 1707283357, 1763375486, 1768617329, 1830310359, 1860705976, 1915412854, 1916009602, 1981972957, 2005358264, 2022294396, 2025055113, 2027516754, 2048392659, 2049945213, 2054707467, 2082663554, 2094299916, 2127021138};
		
		protected static string[] fields = new string[]{"a", "b", "i", "m", "x", "y", "id", "__a", "arr", "get", "len", "map", "pop", "pos", "set", "str", "evaluter", "flags", "readAll", "getEnumConstructs", "remove", "addMove", "filter", "addMoves", "target", "mines", "resize", "table", "moves", "parseString", "readBytes", "stream", "methodName", "iterator", "lastIndexOf", "hasNext", "undoMove", "getMove", "reverse", "punters", "nOccupied", "getBytes", "insert", "length", "maxScore", "getFor", "setupMap", "invalidNumber", "invalidChar", "punterCount", "source", "cachedIndex", "evalFor", "toString", "owner", "accessableSites", "searchRivers", "getLivingRivers", "_eof", "splice", "exists", "copy", "getAnother", "eval", "game", "scores", "join", "keys", "concat", "claim", "move", "close", "next", "enumConstructor", "pass", "push", "size", "sort", "quicksort", "vals", "siteCount", "values", "scoreDictionary", "spliceVoid", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "parseRec", "rivers", "timeout", "setupPunters", "concatNative", "nBuckets", "className", "riverCount", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "fileName", "mineCount", "toDynamic", "isMine", "readByte", "allEnums", "customParams", "punter", "__get", "__set", "lineNumber", "undoClaim", "upperBound", "unshift", "score", "_keys", "setup", "enumParameters", "shift", "sites", "slice"};
